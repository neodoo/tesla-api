...
public class HonkHorn {
	
	private final static Logger log = Logger.getLogger(HonkHorn.class.getName());

	public static final String URL_HONK_HORN = "/command/honk_horn";

	private TeslaInvoker teslaInvoker;

	public HonkHorn(TeslaInvoker teslaInvoker) {
	...
	public HonkHornResponse execute(int vehicleId) throws OauthInvokerException, TeslaInvokerException{
		...
		try {
			...
			WebResource webResource = client.resource(teslaInvoker.getUri() + "/" + TeslaInvoker.URL_PATH_VEHICLES + "/" + vehicleId + URL_HONK_HORN);
			...
			honkHornResponse =  HonkHornResponse.toObject(output);
			...
			throw new TeslaInvokerException("Error invoking chonk horn service: " + e.getMessage());
		}
