...
public class RemoteStart {
	...
	private final static Logger log = Logger.getLogger(RemoteStart.class.getName());
	...
	public RemoteStartResponse execute(int vehicleId, String password) throws OauthInvokerException, TeslaInvokerException{
		...
		try {
			...
			throw new TeslaInvokerException("Error invoking remote start service: " + e.getMessage());
		}
