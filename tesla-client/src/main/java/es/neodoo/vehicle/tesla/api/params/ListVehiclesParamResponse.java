...
public class ListVehiclesParamResponse {
	...
	public String getOptions_codes() {
		return options_codes;
	}

	public void setOptions_codes(String options_codes) {
		this.options_codes = options_codes;
	}
